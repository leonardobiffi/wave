...
binary_name="wave"
version=$(curl -s https://api.github.com/repos/leonardobiffi/wave/releases/latest | jq .name -r)
url="https://github.com/leonardobiffi/wave/releases/download/$version"
